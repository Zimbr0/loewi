...
Dasselbe gilt für die freien Felder im Organisation-Tab: Ein Termin „Elterngespräch Familie K.“ ist ein Datensatz über ein Kind und seine Familie. Loewi hindert dich nicht daran — aber es ist der Punkt, an dem das Prinzip kippt.
...
| | |
|---|---|
| **Stundenplan** | Einmal eintragen, gilt jede Woche. Antippen einer Stunde stellt Klasse und Fach um, legt die Stunde für dieses Datum an und springt direkt ins Eintragen. Am Schultag zeigt ein Streifen, welche Stunde gerade läuft und was als Nächstes kommt. Tages- und Wochenansicht. |
| **Stunden erfassen** | Mitarbeit als `+ / o / –`, dazu *krank* und *vergessen*, Notiz je Kind, Hausaufgabe je Stunde. „Alle anderen auf +“ für den Regelfall. Wer am selben Tag schon in einer anderen Stunde gefehlt hat, wird zur Übernahme angeboten. Ausfall mit einem Griff. |
| **Organisation** | Was heute ansteht (vormittags) und was noch offen ist (nachmittags), Termine, To-do-Liste sowie Ferien und freie Tage. An freien Tagen zeigt der Plan keine Stunden. |
| **Plus-Knopf** | Unten links, über allem: Stunde, Hausaufgabe, Beobachtung, Aufgabe, Termin oder Test von jeder Stelle aus anlegen. |
| **Klassen & Fächer** | Getrennt voneinander; Stunden hängen an Klasse *und* Fach. Auswahl oben in der Kopfzeile. „Vergessen“ heißt je Fach anders — in Sport Sportzeug, in Deutsch Hausaufgaben. |
...
| **Klassenliste** | „Wer braucht einen Blick?“ nennt in Worten, warum ein Kind auffällt — Fehlzeiten am Stück, Vergessen, nachlassende Mitarbeit. Darunter die ganze Klasse mit Trendpfeil und eine Bemerkung je Nummer. |
...
| **Berichte** | Excel-Mappe mit bis zu sechs Blättern; PDF-Bericht je Kind oder für die ganze Klasse — beides im Programm selbst erzeugt, ohne fremde Bibliothek. |
| **Helles und dunkles Design** | Umschalter oben rechts; ohne eigene Wahl folgt Loewi der Einstellung des Geräts. |
